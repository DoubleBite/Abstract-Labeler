...
2. 每一筆上傳的 submission 皆用其檔案名稱作為 document 的 ID (因此後面上傳的會蓋過前面上傳的)

+ target: 所有屬於 target 的句子，非連續標注的句子跟句子之間用 \n 做分隔
+ method:  所有屬於 method 的句子，非連續標注的句子跟句子之間用 \n 做分隔
+ result:  所有屬於 target 的句子，非連續標注的句子跟句子之間用 \n 做分隔
+ type: 這篇論文的性質
